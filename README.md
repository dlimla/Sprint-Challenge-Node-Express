...
- [x] Mention two parts of Express that you learned about this week.
    1. allows us to create middleware that will listen to differerent parts of a framework rather than relying on cascading code.
    2. It is a server side framework that helps us manage data

- [x] Describe Middleware?
    middle ware is a "bunch of functions" that helps us manage different bits of data rather than manuelling do it everytime

- [?] Describe a Resource?
    not too sure, a way for someone to gather information so that someone else looking at your code has no trouble reading what you wrote?

- [x] What can the API return to help clients know if a request was successful?
    a response 
- [x] How can we partition our application into sub-applications?
    throught routes and different doc tyeps
